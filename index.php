      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
          <div class="jumbotron" style="margin: 20px 20px 20px 20px; padding: 20px 20px 20px 20px">
              ...
              Ini Adalah UTS Pemrograman Web Lanjutan
              </h2>
              <h3 class="text-center">
              Aplikasi php sederhana untuk mendata pembayaran Zakat Mal Masjid Silahturahmi Martubung
              </h3>
              <br>
              <p>
                Maulana Al hilmi <br>
                  <ul>
                    <li>NIM : 0702193207</li>
                    <li>Sistem Informasi-4</li>
